...
<form method="post" action="editpost.php">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" value = "<?php echo $attendee['dateofbirth']?>" d="dob" name="dob">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <small id="phone" class="form-text text-muted">We'll never share your phone number with anyone 
        else.</small>
    </div>
